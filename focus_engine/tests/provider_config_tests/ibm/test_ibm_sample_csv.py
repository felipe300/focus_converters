...
class TestIBMSampleCSV(TestCase):
    def test_sample_csv_dataset(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            export_path = pathlib.Path(temp_dir) / "ibm_sample_csv_dataset"
            ...
            converter.load_data(
                data_path="tests/provider_config_tests/ibm/sample-anonymous-ea-export-dataset.csv",
            ...
            converter.prepare_horizontal_conversion_plan(provider="ibm")
